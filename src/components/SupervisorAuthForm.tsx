  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        console.log('[SupervisorAuth] Signing in...');
        ...
        console.log('[SupervisorAuth] Sign in successful, fetching user profile...');
        ...
        console.log('[SupervisorAuth] User profile:', userData);
