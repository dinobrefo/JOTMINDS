...
>(({ side = "right", className = "", children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={`fixed z-50 gap-4 bg-white dark:bg-gray-950 p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 ${sheetVariants.side[side]} ${className}`}
      {...props}
    >
      {children}
